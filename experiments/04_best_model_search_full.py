...
#
# Best-model search (full) + compact-CNN reference + operation-count proxy
# Paper: Section 4.2 / Table 2 (tuned Doppler 0.924, Vanilla 0.857, Parametric 0.852,
# small-CNN reference 0.932). Adds Parametric-LIF, SmallCNN and the MAC/AC count.
# No energy claim is made in the paper; the count is a proxy only.
# Source cell: "Shd deep probe" notebook, cell 3.
# ============================================================================
