...
# ==========================================================================
# Experiment 1/3 (harness probe, not a paper table): SHD T=12 smoke, speed and
# firing-stability check before the DIAT headline.

import mstask  # ensures dikmen-spiking-neurons is importable
from mstask.core import (
    FeatureStack, PathBankNet, VerticalNet, _calibrate_stack, _make_norm, _solve_width, calibrate_thresholds, count_params, firing_snapshot, get_dataset_path, load_registry, register_dataset,
)
...
if 'shd' not in load_registry():
    register_dataset('shd',
        path=os.environ.get('SHD_CACHE', '/content/drive/MyDrive/Research/GHN_Instinct/gesture_cache/shd_T12_m200_v2.pt'),
